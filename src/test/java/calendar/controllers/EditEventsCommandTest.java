...
/**
 * Tests for EditEventsCommand - specific condition coverage.
 */
public class EditEventsCommandTest {
  ...
  public void testEditEventsEventNotFound() {
    ...
    Command c = new EditEventsCommand(model, view, EventProperty.SUBJECT,
  ...
  @Test
  public void testEditEventsMultipleEventsFound() {
  ...
  @Test
  public void testEditEventsSingleEventNotPartOfSeries() {
  ...
  @Test
  public void testEditEventsIllegalArgumentExceptionCaught() {
    Event event = EventImpl.getBuilder()
        .subject("Test Event")
        .from(date, startTime)
        .to(date, endTime)
    ...
    Command c = new EditEventsCommand(model, view, EventProperty.LOCATION,
